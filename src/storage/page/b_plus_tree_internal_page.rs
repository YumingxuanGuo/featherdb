...
pub struct BPlusTreeInternalPage {
    ...
    array: [(KeyType, ValueType); KVPAIR_SIZE]
}

impl BPlusTreePageTraits for BPlusTreeInternalPage {
    fn is_leaf_page(&self) -> bool { return true; }
    fn is_root_page(&self) -> bool { return false; }
    fn set_page_type(&mut self, page_type: IndexPageType) { self.b_plus_tree_page.page_type = page_type; }
